...
aws elasticbeanstalk create-configuration-template --application-name peerbelt --template-name peerbelt-temp
aws elasticbeanstalk create-environment  --application-name peerbelt-api -e TEST-$SHA1 -t peerbelt-temp
